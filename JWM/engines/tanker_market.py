...
class TankerMarketEngine(Engine):
    name = """Jordan-Wide Tanker Market Institution matches sellers (highland farmers) with buyers (households)"""

    def run(self):
        """
            The target of this is the Jordan-wide tanker market institution
        """
        self.target.det_tanker_market_contracts()
